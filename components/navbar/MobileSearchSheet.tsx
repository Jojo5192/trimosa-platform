  ...
  <div style={{
    ...
    <div style={{ padding: '16px 16px 32px', backgroundColor: '#fff', borderTop: '1px solid #F0EEE8', display: 'flex', gap: '10px' }}>
      ...
      <button
        type="button"
        onClick={onSearch}
        style={{ flex: 1, padding: '14px', borderRadius: '999px', border: 'none', background: 'var(--gold)', color: '#fff', fontSize: '15px', fontWeight: 700, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}
      >
