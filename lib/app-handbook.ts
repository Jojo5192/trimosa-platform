...
- „📁 Ältere Chats laden" (Button am Ende der Liste, Filter „Alle"): lädt alle vergangenen Buchungen mit Chat-Verlauf seit 2019 nach — beim Öffnen eines alten Threads erscheint der komplette Verlauf. FeWo-Gast-Nachrichten, die per Mail eintreffen, landen automatisch im passenden Chat-Thread (inkl. Push).
