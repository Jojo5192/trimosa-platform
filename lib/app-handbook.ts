...
- „📁 Ältere Chats laden" (Button am Ende der Liste, Filter „Alle"): lädt alle vergangenen Buchungen mit Chat-Verlauf seit 2019 nach — beim Öffnen eines alten Threads erscheint der komplette Verlauf. FeWo-Gast-Nachrichten, die per Mail eintreffen, landen automatisch im passenden Chat-Thread (inkl. Push). Auch E-Mail-ANTWORTEN von Website-Gästen (auf unsere Bestätigungs-Mail von buchung@) werden automatisch dem richtigen Chat-Thread zugeordnet — die KI entfernt dabei Zitat und Signatur, Push kommt wie bei jeder Gast-Nachricht.
- Thread-Kopf antippen: Gast-Karte (Aufenthalt, Personen, Wohnung, Kanal, Sprache). Buttons ✓ „Keine Antwort nötig" und 📞 „Telefonisch geklärt" (fließen in den Wochenbericht ein). Die Markierungen gelten für das GANZE Team — ein gemeinsamer Zustand pro Thread, jeder sieht, was ein Kollege gesetzt hat. Eine neue Gast-Nachricht setzt die Markierung automatisch zurück.
- Neue Portal-Nachrichten (Airbnb/Booking/FeWo via Smoobu) kommen SOFORT in die App — Smoobu meldet jede neue Nachricht per Webhook, sie wird direkt gespeichert, übersetzt und gepusht. Ein 10-Minuten-Poll läuft zusätzlich als Sicherheitsnetz (rund um den Aufenthalt; zweimal pro Stunde erweitert bis 60 Tage vor Anreise / 21 Tage nach Abreise). Ganz alte Threads aktualisieren sich beim Öffnen. Website-Gäste und FeWo-Mail-Nachrichten kommen ebenfalls sofort.
...
- 🔑 Service-PINs: Über dem Kalender zeigt eine Navy-Karte die Keypad-Service-PINs der Wohnungen (für Reinigung/Handwerker; im Admin-Bereich unter „Türcodes" gepflegt, gefiltert nach Kalender-Sichtbarkeit).
...
WEBSITE (trimosa.de): Buchung mit Sofortbuchung/Anfrage je Inserat, Stripe-Zahlung (live), Bestpreis-Garantie, automatische Bestätigungs-Mail (mehrsprachig) + Host-Alert-Mail, beidseitiger Smoobu-Sync, Bewertungs-Import (Airbnb/Booking/FeWo/Google, täglicher Cron) mit Gesamtscore + „Das sagen unsere Gäste"-KI-Zusammenfassung, Reiseführer (4 Regionen, ~43 Erlebnis-Seiten, Kulinarik-Guide mit Google-Ratings, Komoot-Touren, persönliche Gastgeber-Empfehlungen), komplette Mehrsprachigkeit DE/EN/FR/NL, digitale Gästemappe je Buchung (/mappe/<token>, mehrsprachig) MIT 💬 Gäste-Chat direkt in der Mappe (schreibt in die Team-Inbox mit Push — funktioniert auch für Airbnb/Booking/FeWo-Gäste ohne Konto, am Portal vorbei; offen bis 30 Tage nach Abreise), Bausteine je nach Aufenthalts-PHASE steuerbar (immer / nur vor Anreise / während / erst nach Abreise, optional erst ab X Nächten — im Builder je Baustein einstellbar) und MIT automatischem Türcode: Sobald einer Wohnung Nuki-Schlösser zugeordnet sind (Admin → 🔑 Türcodes), bekommt jede bestätigte Buchung automatisch einen eigenen Keypad-Code (gültig Anreise bis Abreise, wird danach abgeräumt); der Code erscheint in der Mappe erst X Tage vor Anreise (einstellbar, Standard 3).

DASHBOARD (/dashboard, Admins/Gastgeber): Inserats-Editor (Fotos, Zimmer, Grundrisse, Buchungsmodus, Storno-Richtlinie, KI-Formulierhilfe ✨, Bewertungs-Sync, Übersetzungen), Gästemappen-Builder mit Live-Vorschau, Empfehlungen-Editor, Buchungsverwaltung, Admin-Bereich in thematischen REITERN: 👥 Team & Rechte (Rollen, Aufgaben-Rechte, Kalender-Sichten) · 🧹 Betrieb & QS (Reinigung inkl. Kosten-Sätze, QS-Einstellungen + Checklisten-Editor) · 🔑 Türcodes (Nuki-Schloss-Zuordnung, Code-Zeitfenster mit Uhrzeit, Service-PINs) · 🤖 KI (Chat-Wissensbasis, Prompt-Studio) · 👁 Wer sieht was (Rollen-Übersicht); jeder Reiter vermerkt, für wen die Einstellungen sichtbar sind und auf wen sie wirken.
