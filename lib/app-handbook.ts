...
- Fremdsprachige Gast-Nachrichten werden automatisch auf Deutsch angezeigt (Flagge + „Original zeigen"); eigene Antworten werden beim Senden automatisch in die Gastsprache übersetzt (Original bleibt einsehbar).
